...
- **Design spikes (noted 2026-08-03):** scroll-driven `.plane-silhouette` motion (row L→R / column bottom→top, center-viewport arrival); airport names alongside codes
